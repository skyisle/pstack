...
1. Use the **skill-creator** skill (Claude Code's built-in for authoring SKILL.md files).
2. Validate the skill: frontmatter `name` is kebab-case and matches the directory, `description` is present and under 1024 characters, referenced files exist, cross-skill links resolve.
